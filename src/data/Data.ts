...
class Data {
  ...
  title = `Portafolio de ${this.myData.devName}`;
  ...
  serviceId: string = import.meta.env.VITE_EJS_SERVICE_ID;
  templateId: string = import.meta.env.VITE_EJS_TEMPLATE_ID;
  userId: string = import.meta.env.VITE_EJS_USER_ID;
  contactDesc =
